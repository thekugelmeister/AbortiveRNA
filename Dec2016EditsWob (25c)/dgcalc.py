...
for f in [termForward, termReverse]:
    ...
    for i in xrange(0,numEntries):
        ...
        termLength = int(lines[(5 * i) + 3].split()[4]) - int(lines[(5 * i) + 3].split()[3])
        ...
        tOFile.write(operonName + " " + tranName + " " + termName + " " + strand + " " + bindSeq + " " + abortSeq + " " + str(abortLen) + " " + termDG + " " + str(termLength) + " ")
...
#     tuName = lines[i].split()[0]
#     strand = lines[i].split()[4]
#     boundOne = lines[i].split()[2]
#     boundTwo = lines[i].split()[3]
#     bOFile.write(tuName + " " + tranName + " " + boundOne + " " + boundTwo + " " + strand + " ")
#     with open("test.seq", "w") as seqFile:
#         seqFile.write("{bseq}&{aseq}".format(bseq=bindSeq, aseq=abortSeq))
#     # perform the dG calculation for the given entry
#     os.system("RNAcofold --noPS -T 25 < test.seq > result.txt")
...
#         except AttributeError:
#             deltaG = "ERROR"
#             print "ERROR: " + tuName + " " + tranName + " " + boundOne + " " + boundTwo + " " + strand + " "
#     bOFile.write(deltaG + "\n")
#     # clean up directory
#     os.system("rm test.seq result.txt")    
